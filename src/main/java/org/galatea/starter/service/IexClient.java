...
public interface IexClient {
  ...
  List<IexSymbol> getAllSymbols(@RequestParam(value = "token", required = false, defaultValue = "${spring.datasource.token}")
                                String token);
  ...
  List<IexLastTradedPrice> getLastTradedPriceForSymbols(@RequestParam("symbols") String[] symbols, @RequestParam(value = "token", required = false, defaultValue = "${spring.datasource.token}")
  String token);
